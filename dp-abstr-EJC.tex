% This is the version of dp-abstr.tex submitted to the Electronic
% Journal of Combinatorics for the editors' post-review on the 13th
% of April 2017.
% It corresponds to the standard version (i.e., the "vershort"
% version) of arXiv:1509.08355v3, apart from formatting and style
% (in particular, it uses the EJC's style package, and \doi and
% \arxiv commands).
...
power series form a $\kk$-subalgebra of \newline
$\Powser$. But usually one
...
\bibitem{Abe-HA}Eiichi Abe, \textit{Hopf Algebras}, CUP 1977.

\bibitem{BenSag}Carolina Benedetti, Bruce Sagan,
...
\bibitem{BBSSZ}Chris Berg, Nantel Bergeron, Franco Saliola, Luis
...
\bibitem{Dasca-HA}Sorin D\u{a}sc\u{a}lescu, Constantin
...
\bibitem{Fresse-Op}Benoit Fresse, \textit{Homotopy of operads \&
...
\bibitem{Gessel}Ira M. Gessel, \textit{Multipartite
...
\bibitem{Gri-dimm}Darij Grinberg,
...
\bibitem{Gri-nbc}Darij Grinberg,
...
\bibitem{Reiner}Darij Grinberg, Victor Reiner, \textit{Hopf algebras
in Combinatorics}, August 22, 2016, \arxiv{1409.8356v4}.\newline
\url{http://www.cip.ifi.lmu.de/~grinberg/algebra/HopfComb-sols.pdf}

\bibitem{HGK}Michiel Hazewinkel, Nadiya Gubareni, V. V. Kirichenko,
\textit{Algebras, Rings and Modules: Lie Algebras and Hopf Algebras},
AMS 2010.

\bibitem{Joch}Katharina Jochemko, \textit{Order polynomials and
...
\bibitem{Malve-Thesis}Claudia Malvenuto, \textit{Produits et
...
\bibitem{Mal-Reu}Claudia Malvenuto, Christophe Reutenauer,
...
\bibitem{Mal-Reu-DP}Claudia Malvenuto, Christophe Reutenauer,
...
\bibitem{Manchon-HA}Dominique Manchon, \textit{Hopf algebras, from
...
\bibitem{Montg-Hopf}Susan Montgomery, \textit{Hopf Algebras and their
Actions on Rings}, Regional Conference Series in Mathematics Nr. 82, AMS 1993.

\bibitem{Nov-Thi} Jean-Christophe Novelli, Jean-Yves Thibon,
...
\bibitem{SageMath}The Sage Developers, \textit{SageMath,
the Sage Mathematics Software System} (Version 7.4), 2016.
\url{http://www.sagemath.org}

\bibitem{Stanley-EC1}Richard P. Stanley, \textit{Enumerative
Combinatorics, volume 1}, Cambridge University Press, 2011. \newline%
\url{http://math.mit.edu/~rstan/ec/ec1/}

\bibitem{Stanley-EC2}Richard P. Stanley, \textit{Enumerative
Combinatorics, volume 2}, Cambridge University Press, 1999.

\bibitem{Stanley-Thes}Richard P. Stanley, \textit{Ordered Structures and
