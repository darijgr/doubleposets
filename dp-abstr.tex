...
given in \cite[Theorem 5.11]{Reiner} and in
...
$<_2$ is chosen to be total) yields the formula for the
antipode of a fundamental quasisymmetric function
(\cite[(5.9)]{Reiner}, \cite[Theorem 5.1]{BenSag}).
...
\url{http://math.univ-lille1.fr/~fresse/OperadGT-December2012Preprint.pdf}
