...
\xx_{\pi, w}
= \sum_{\pi : E \to \left\{1, 2, 3, \ldots\right\}} 0 = 0.
\end{align*}
%\footnote{Here, for the fifth-to-last equality sign, we have
...
= \left(-1\right)^{\left|E\right|}
\Gamma\left(\left(E, >_1, <_2\right), w\right)$. This completes the
