...
\date{version 3.1 (April 28, 2017, typos corrected 2026) \\[1pc]
Corrected version of:
\href{https://doi.org/10.37236/6660}{%
Darij Grinberg, \textit{Double Posets and the Antipode of QSym},
The Electronic Journal of Combinatorics \textbf{24} (2), P2.22.}
}
...
\begin{abstract}
Une fonction quasi-sym\'etrique est attribu\'ee \`a chaque ``double
poset'' (c'est-\`a-dire, ensemble fini dot\'e de deux ordres
partiels) et chaque fonction de poids sur son ensemble
sous-jacent. Cela g\'en\'eralise des objets bien connus tels que les
fonctions quasi-sym\'etriques fondamentales et monomiales, les
fonctions de Schur (obliques), les fonctions immacul\'ees duales,
et les $\left(P, \omega \right)$-partition enumerateurs
quasi-sym\'etriques.
Nous montrons une formule pour l'antipode de cette fonction
valable dans certaines conditions (qui sont satisfaites
lorsque le second ordre
de la double poset est total, mais aussi dans d'autres cas); ce
r\'eaffirme (d'une mani\`ere qui nous semble plus naturelle) un
r\'esultat par Malvenuto et Reutenauer, mais notre preuve est nouvelle et
autonome. Nous g\'en\'eralisons ce r\'esultat plus loin \`a une situation
plus complexe,
o\`u un groupe agit sur le ``double poset'' par automorphismes.
\end{abstract}
\end{comment}
...
\url{http://www.cip.ifi.lmu.de/~grinberg/algebra/dp-abstr.pdf}
and
...
Combinatorics}
in 2017
(\href{https://doi.org/10.37236/6660}{Volume 24, Issue 2,
doi:10.37236/6660}).
...
(as in \cite[Proof of Corollary 2.6.11]{Reiner}):
...
difficulty\footnote{See \cite[(5.1.7)]{Reiner} for the details.}.
...
the $P$-partitions in the terminology of \cite[Definition 5.2.1]{Reiner},
where $P$ is the labelled poset $\left(E, <_1\right)$; and furthermore,
our $\Gamma\left(\EE\right)$ is the $F_P\left(\xx\right)$ of
\cite[Definition 5.2.1]{Reiner}. Conversely, if $P$ is a labelled poset, then
the $F_P\left(\xx\right)$ of \cite[Definition 5.2.1]{Reiner} is our
...
\cite[Corollary 5.2.20]{Reiner}\footnote{It is easiest to derive
\cite[Corollary 5.2.20]{Reiner} from our Corollary~\ref{cor.antipode.Gamma},
...
\cite[Theorem 5.1.11]{Reiner}, and in
...
(\cite[(4.27)]{Malve-Thesis}, \cite[(5.2.7)]{Reiner}, \cite[Theorem 5.1]{BenSag}).
...
\cite[Remark 2.2.5]{Reiner} shows that
$\Gamma\left(\left(Y\left(\lambda / \mu\right), >_1, >_2\right)\right)
...
was done in \cite[proof of Corollary 5.2.22]{Reiner}.)
...
\end{vershort}
\begin{verlong}
(by Proposition~\ref{prop.ev.comp} (a) (applied to $\varphi$
instead of $\pi$)).
\end{verlong}
...
The map $T$ is an involution, and thus a bijection.
...
Now, \cite[Proposition 7.1.7 (i)]{Reiner} shows that, for any given
...
(b) \cite[Proposition 7.1.7 (i)]{Reiner} shows that, for any given
$f\in \QSym $, there exists a unique polynomial in $\QQ
\left[  X\right]  $ whose value on each $q\in \NN $ equals
$\operatorname{ps}^{1}\left(  f\right)  \left(  q\right)  $. This
polynomial is denoted by $\operatorname{ps}^{1}\left(  f\right)  $
in \cite[Proposition 7.1.7]{Reiner}. From our above proof of Corollary
...
But \cite[Proposition 7.1.7 (iii)]{Reiner} shows that, for any
...
that study is the bijection $\Phi$ in \cite[proofs of Lemma 2.8, Lemma
5.29 and Lemma 8.25]{Gri-nbc}, which is uncannily reminiscent of the
involution $T$ in the proof
...
with that given in \cite[Definition 5.1.10]{Reiner}.)
...
Finally, using \cite[Proposition 1.4.16]{Reiner}, we can leverage Proposition
...
example, in \cite[Proposition 1.4.16]{Reiner}.} Applying this to the connected
...
equivalent to \cite[Theorem 5.1.11]{Reiner}.\footnote{Indeed, the $\ell\left(
\alpha\right)  $ in \cite[Theorem 5.1.11]{Reiner} is precisely what we call
...
\alpha\right)  $\textquotedblright\ in \cite[Theorem 5.1.11]{Reiner} is
...
Proposition \ref{prop.SF} is \cite[(5.2.7)]{Reiner} (although \cite{Reiner} uses
...
(2014), pp. 525--565.\newline
\url{https://doi.org/10.4153/CJM-2013-013-0}
...
\newline\url{https://doi.org/10.1006/aima.1996.0026}
...
\newline A preprint is available as arXiv:1109.1101v4.\newline
\url{https://arxiv.org/abs/1109.1101v4}

\bibitem[Fresse14]{Fresse-Op}
Benoit Fresse, \textit{Homotopy of operads and
Grothendieck--Teichm\"{u}ller groups, Part I},
Mathematical Surveys and Monographs \textbf{217},
AMS 2017.
A preprint can be found at
\url{http://web.archive.org/web/20160213160358/http://math.univ-lille1.fr/~fresse/OperadHomotopyBook/OperadHomotopy-FirstVolume.pdf} .
...
\href{http://arxiv.org/abs/1410.0079v7}{arXiv:1410.0079v7}.

\bibitem[Grin16a]{Gri-nbc}Darij Grinberg,
\textit{Generalized Whitney formulas for
broken circuits in ambigraphs and
matroids},
\href{https://arxiv.org/abs/1604.03063v2}{arXiv:1604.03063v2}.
...
\newline\url{https://doi.org/10.1006/jabr.1995.1336}
...
\url{https://doi.org/10.1016/S0012-365X(98)00142-3}
...
\newline
\url{https://doi.org/10.1016/j.jcta.2010.10.010} . \\
A preprint version appeared as
\href{http://arxiv.org/abs/0905.3508v1}{arXiv:0905.3508v1}. \\
See \url{https://www.cip.ifi.lmu.de/~grinberg/algebra/doubleposets-errata.pdf}
for errata.
...
Actions on Rings}, Regional Conference Series in Mathematics \textbf{82},
AMS 1993.
...
\newline \url{http://math.mit.edu/~rstan/ec/ec1/}
...
\newline \url{https://math.mit.edu/~rstan/ec/}
...
\url{https://math.mit.edu/~rstan/pubs/pubfiles/9.pdf}
