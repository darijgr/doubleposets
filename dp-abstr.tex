...
$\mathbf{k}\left[  \left[ \xx \right]  \right]  $ by a coefficientwise
...
=\xx_{\pi,w}%
\end{align*}
(by the definition of $\xx_{\pi,w}$). This proves Proposition
...
}}\xx_{\pi,w}=\Gamma\left(   \EE ^{g},w^{g}\right)
...
\\g\pi=\pi}}\xx_{\pi,w}=\sum_{\pi\text{ is an }
\EE ^{g}\text{-partition}}\xx_{\pi,w^{g}}
=\Gamma\left(  \EE^{g},w^{g}\right)  $
...
\begin{align}
\Gamma\left( \EE , w, G\right)   &  =\sum_{O\text{ is a
}G\text{-orbit on }\operatorname{Par} \EE }\underbrace{\xx_{O,w}}_{
...
\operatorname{Par} \EE } \xx_{O,w}}\left(
\underbrace{1,1,\ldots,1}_{q\text{ times}},0,0,0,\ldots\right) \nonumber\\
&  =\sum_{O\text{ is a }G\text{-orbit on }\operatorname{Par} \EE %
